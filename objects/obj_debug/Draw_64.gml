...
draw_text_transformed_color(0,30,string("Room:{0}({1})\n",room,room_get_name(room)),1,1,0, make_color_rgb(random(255), random(255), random(255)), make_color_rgb(random(255), random(255), random(255)), make_color_rgb(random(255), random(255), random(255)), make_color_rgb(random(255), random(255), random(255)),1);
