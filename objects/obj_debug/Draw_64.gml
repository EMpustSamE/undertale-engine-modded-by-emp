...
draw_text_transformed_color(0,30,string("Room:{0}({1})\nFPS:{2}({3})\nInstance Count:{4}",room,room_get_name(room),fps,fps_real,instance_count),1,1,0, make_color_rgb(random(255), random(255), random(255)), make_color_rgb(random(255), random(255), random(255)), make_color_rgb(random(255), random(255), random(255)), make_color_rgb(random(255), random(255), random(255)),1);
